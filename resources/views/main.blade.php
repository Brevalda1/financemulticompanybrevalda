        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>Gaji Pegawai </a>
                        ...
                        <a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>Pencatatan rekening</a>
                        <a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>Pencatatan masa depan</a>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="ui-buttons.html">Biaya operational proyek</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">Biaya pribadi</a></li>
                            <li><i class="fa fa-bars"></i><a href="ui-tabs.html">Biaya lain-lain</a></li>
                            <li><i class="fa fa-share-square-o"></i><a href="ui-social-buttons.html">Biaya operational non budgeting</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="font-fontawesome.html">Register</a></li>
